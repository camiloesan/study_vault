...
class AuthService {
  static Future<http.Response> login(
    ...
    final url = Uri.parse('http://192.168.1.112:8085/login');
  ...
  static Future<http.Response> sendVerificationCode(
    ...
    try {
      response = await http.post(
        Uri.parse('http://192.168.1.112:8085/user/verification/request'),
        headers: headers,
        body: '"$email"',
      );
    } catch (e) {
  ...
  static Future<http.Response> verifyCode(
    ...
    try {
      response = await http.post(
        Uri.parse('http://192.168.1.112:8085/user/verify'),
        headers: headers,
